  ...
  List<Achievement> achievementsFor(DemoAppState state) {
    ...
    return <Achievement>[
      _achievement(
        ...
        const LocalizedText(
          ru: 'Завершите первый урок в любой ветке.',
          en: 'Complete the first lesson in any branch.',
          kk: 'Кез келген бұтақта алғашқы сабақты аяқтаңыз.',
        ),
        Icons.flag_rounded,
        1,
        completedLessons,
      ...
      _achievement(
        'lesson_runner',
        const LocalizedText(
          ru: 'Бегущий по урокам',
          en: 'Lesson runner',
          kk: 'Сабақ жүгірушісі',
        ),
        const LocalizedText(
          ru: 'Завершите 6 уроков в дереве знаний.',
          en: 'Finish 6 lessons across the tree.',
          kk: 'Білім ағашында 6 сабақты аяқтаңыз.',
        ),
      ...
      _achievement(
        ...
        const LocalizedText(
          ru: 'Инженер-практик',
          en: 'Practice engineer',
          kk: 'Тәжірибелік инженер',
        ),
        const LocalizedText(
          ru: 'Выполните 4 практических задания.',
          en: 'Close 4 hands-on tasks.',
          kk: '4 практикалық тапсырманы орындаңыз.',
        ),
        Icons.code_rounded,
        4,
        completedPractices,
      ...
      _achievement(
        ...
        const LocalizedText(
          ru: 'Решите 10 тестов на вывод программы.',
          en: 'Solve 10 output quizzes.',
          kk: 'Бағдарлама нәтижесі бойынша 10 тестті шешіңіз.',
        ),
        Icons.quiz_rounded,
        10,
        completedQuizzes,
      ...
      _achievement(
        ...
        const LocalizedText(
          ru: 'Тренер памяти',
          en: 'Memory builder',
          kk: 'Жады жаттықтырушысы',
        ),
        const LocalizedText(
          ru: 'Пройдите 10 тренажёров памяти кода.',
          en: 'Finish 10 code memory labs.',
          kk: 'Код жадысы бойынша 10 жаттығуды аяқтаңыз.',
        ),
      ...
      _achievement(
        ...
        const LocalizedText(
          ru: 'Наберите серию занятий длиной 7 дней.',
          en: 'Reach a 7-day streak.',
          kk: '7 күндік серияға жетіңіз.',
        ),
      ...
      _achievement(
        'xp_900',
        const LocalizedText(ru: '900 XP', en: 'XP 900', kk: '900 XP'),
        const LocalizedText(
          ru: 'Наберите 900 XP на пути обучения.',
          en: 'Cross 900 XP in your learning path.',
          kk: 'Оқу жолында 900 XP жинаңыз.',
        ),
        Icons.bolt_rounded,
        900,
        state.xp,
      ...
      _achievement(
        ...
        const LocalizedText(
          ru: 'Отправьте 6 вопросов AI-наставнику.',
          en: 'Send 6 questions to the mentor.',
          kk: 'AI-тәлімгерге 6 сұрақ жіберіңіз.',
        ),
      ...
      _achievement(
        'cs_core_explorer',
        const LocalizedText(
          ru: 'Исследователь CS Core',
          en: 'CS core explorer',
          kk: 'CS Core зерттеушісі',
        ),
        const LocalizedText(
          ru: 'Завершите 2 трека направления Computer Science Core.',
          en: 'Finish 2 Computer Science Core tracks.',
          kk: 'Computer Science Core бағытының 2 тректерін аяқтаңыз.',
        ),
        Icons.hub_rounded,
        2,
        csDone,
      ...
      _achievement(
        ...
        const LocalizedText(
          ru: 'Завершите 2 трека IT-сфер.',
          en: 'Finish 2 IT sphere tracks.',
          kk: 'IT саласының 2 тректерін аяқтаңыз.',
        ),
      ...
      _achievement(
        ...
        const LocalizedText(
          ru: 'Готов к Frontend',
          en: 'Frontend ready',
          kk: 'Frontend-ке дайын',
        ),
        const LocalizedText(
          ru: 'Завершите трек Frontend.',
          en: 'Close the Frontend track.',
          kk: 'Frontend тректерін аяқтаңыз.',
        ),
        Icons.web_rounded,
        1,
        frontendDone,
      ...
      _achievement(
        ...
        const LocalizedText(
          ru: 'Основы систем',
          en: 'Systems foundation',
          kk: 'Жүйелер негізі',
        ),
        const LocalizedText(
          ru: 'Завершите трек «Операционные системы».',
          en: 'Close the Operating Systems track.',
          kk: '«Операциялық жүйелер» тректерін аяқтаңыз.',
        ),
      ...
      _achievement(
        'data_confidence',
        const LocalizedText(
          ru: 'Уверенность в данных',
          en: 'Data confidence',
          kk: 'Деректерге сенімділік',
        ),
        const LocalizedText(
          ru: 'Завершите треки «Базы данных» и «Теория вероятностей и статистика».',
          en: 'Finish Databases and Probability/Statistics.',
          kk: '«Деректер қорлары» және «Ықтималдықтар теориясы және статистика» тректерін аяқтаңыз.',
        ),
      ...
      _achievement(
        'math_canopy',
        const LocalizedText(
          ru: 'Математический свод',
          en: 'Math canopy',
          kk: 'Математика күмбезі',
        ),
        const LocalizedText(
          ru: 'Завершите 3 ветки математических основ.',
          en: 'Finish 3 mathematical foundation branches.',
          kk: 'Математикалық негіздердің 3 бұтағын аяқтаңыз.',
        ),
      ...
      _achievement(
        'algorithmic_mindset',
        const LocalizedText(
          ru: 'Алгоритмическое мышление',
          en: 'Algorithmic mindset',
          kk: 'Алгоритмдік ойлау',
        ),
        const LocalizedText(
          ru: 'Завершите трек «Алгоритмы и структуры данных».',
          en: 'Close Algorithms & Data Structures.',
          kk: '«Алгоритмдер және деректер құрылымдары» тректерін аяқтаңыз.',
        ),
      ...
      _achievement(
        ...
        const LocalizedText(
          ru: 'Завершите трек «Информационные сети».',
          en: 'Close Information Networks.',
          kk: '«Ақпараттық желілер» тректерін аяқтаңыз.',
        ),
        Icons.hub_rounded,
        1,
        networkDone,
      ...
      _achievement(
        ...
        const LocalizedText(
          ru: 'Завершите 3 ветки, связанные с мобильной разработкой.',
          en: 'Finish 3 mobile-related branches.',
          kk: 'Мобильді әзірлеуге қатысты 3 бұтақты аяқтаңыз.',
        ),
      ...
      _achievement(
        ...
        const LocalizedText(
          ru: 'Завершите ветку «QA-инженер».',
          en: 'Close the QA Engineer branch.',
          kk: '«QA-инженер» бұтағын аяқтаңыз.',
        ),
      ...
      _achievement(
        ...
        const LocalizedText(
          ru: 'Завершите ветку «Системное администрирование».',
          en: 'Close the System Administration branch.',
          kk: '«Жүйелік әкімшілендіру» бұтағын аяқтаңыз.',
        ),
      ...
      _achievement(
        ...
        const LocalizedText(
          ru: 'Завершите ветку «ML-инженер».',
          en: 'Close the ML Engineer branch.',
          kk: '«ML-инженер» бұтағын аяқтаңыз.',
        ),
      ...
      _achievement(
        'security_stack',
        const LocalizedText(
          ru: 'Стек безопасности',
          en: 'Security stack',
          kk: 'Қауіпсіздік стегі',
        ),
        const LocalizedText(
          ru: 'Завершите треки «Основы информационной безопасности» и «Кибербезопасность».',
          en: 'Finish Information Security and Cybersecurity.',
          kk: '«Ақпараттық қауіпсіздік негіздері» және «Киберқауіпсіздік» тректерін аяқтаңыз.',
        ),
      ...
      _achievement(
        'community_curator',
        const LocalizedText(
          ru: 'Куратор сообщества',
          en: 'Community curator',
          kk: 'Қоғамдастық кураторы',
        ),
        const LocalizedText(
          ru: 'Просмотрите или сохраните 4 курса сообщества.',
          en: 'View or save 4 community courses.',
          kk: 'Қоғамдастықтың 4 курсын қараңыз немесе сақтаңыз.',
        ),
      ...
      _achievement(
        ...
        const LocalizedText(
          ru: 'Старт оценивания',
          en: 'Assessment starter',
          kk: 'Бағалау старты',
        ),
        const LocalizedText(
          ru: 'Пройдите 3 итоговых теста по веткам.',
          en: 'Pass 3 branch assessments.',
          kk: 'Бұтақтар бойынша 3 қорытынды тестті тапсырыңыз.',
        ),
      ...
      _achievement(
        'assessment_sharp',
        const LocalizedText(
          ru: 'Меткий в оценивании',
          en: 'Assessment sharp',
          kk: 'Бағалауда дәл',
        ),
        const LocalizedText(
          ru: 'Наберите 80% и больше в 4 итоговых тестах.',
          en: 'Reach 80% or more on 4 assessments.',
          kk: '4 қорытынды тестте 80% және одан жоғары нәтиже көрсетіңіз.',
        ),
        Icons.rule_rounded,
        4,
      ...
      _achievement(
        ...
        const LocalizedText(
          ru: 'Знаки мастерства',
          en: 'Mastery badges',
          kk: 'Шеберлік белгілері',
        ),
        const LocalizedText(
          ru: 'Достигните идеальной точности тестов в 2 треках.',
          en: 'Master 2 tracks with perfect quiz accuracy.',
          kk: '2 тректе тесттердің мінсіз дәлдігіне жетіңіз.',
        ),
