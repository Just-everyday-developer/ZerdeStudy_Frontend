        ...
        child: Column(
          children: [
            _DetailHeader(
              ...
              onTitleChanged: (v) =>
                  controller.updateNode(node.id, title: v),
              onDurationChanged: (v) =>
          ...
          Wrap(
            ...
            children: [
              ...
              if (n.itemCount != null)
                _NumberField(
                  label:
                      n.type == CourseNodeType.practice ? 'Puzzles' : 'Items',
                  value: n.itemCount!,
              ...
              children: [
                Row(
                  children: [
                    ...
                    if (b.type == CourseBlockType.video && b.durationMinutes != null) ...[
                      const SizedBox(width: 6),
                    ...
                    if (b.type == CourseBlockType.quiz && b.itemCount != null) ...[
                      const SizedBox(width: 6),
                      Text('· ${b.itemCount} items',
                          style: TextStyle(
                              color: colors.textSecondary,
                              fontSize: 9.5,
                              fontFamily: 'monospace')),
                    ],
                    if (b.type == CourseBlockType.code && b.language != null) ...[
                      const SizedBox(width: 6),
                      Text('· ${b.language}',
                          style: TextStyle(
                              color: colors.textSecondary,
